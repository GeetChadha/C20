...
function createDiamonds() {
  ...
  var diamonds = createSprite(Math.round(random(50, 350),40,height-70, 10));
...
function createJwellery() {
  ...
  var jwellery = createSprite(Math.round(random(50, 350),40,height-70,10 ))
...
function createSword(){
  if (World.frameCount % 530 == 0) {
    ...
    var sword = createSprite(Math.round(random(50, 350),40, height-70, 10));
